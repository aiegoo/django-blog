...
class DetailView(generic.DetailView):
    ...
    def get_object(self):
        ...
        # Set the increase of page views to determine the time. If the same article is viewed more than half an hour twice, the page views will be re-counted. The author will ignore the view.
        u = self.request.user
