...
class Article (models.Model):
    ...
    summary = models.TextField ('Article summary', max_length = 230, default = 'Article summary is equivalent to the description content of the webpage, please fill in ...')
...
class Carousel (models.Model):
    number = models.IntegerField ('Number', help_text = 'Number determines the order in which pictures are played, not more than 5 pictures')
    ...
    url = models.CharField ('Jump link', max_length = 200, default = '#', help_text = 'Hyperlink for image jump, default # means no jump')
...
class Silian(models.Model):
    badurl = models.CharField ('Dead chain address', max_length = 200, help_text = 'Note: The address is in the full link format starting with http')
...
class FriendLink (models.Model):
    ...
    link = models.URLField ('Friendly chain address', help_text = 'Please fill in the full form address starting with http or https')
    logo = models.URLField ('Website Logo', help_text = 'Please fill in the full form address starting with http or https', blank = True)
